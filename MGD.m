...
syms t;                 % tangente de la moitié de l'angle de rotation en z du centre de gravité de R1R2R3
...
G(1:6,3) = rotz*180/pi; % Stocker rotation du triangle sur l'axe z en degré

for i=1:6 % Déterminer coordonnées de R1 R2 R3
